...
- `--strict` additionally enforces on unmigrated skills, making every PR that touches one a blocker. It's a lever for *forcing* migration, not a cleanup step for afterwards — once all skills are migrated it does nothing
